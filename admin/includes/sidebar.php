...
<li><a href="upcoming_products.php"><i class="menu-icon icon-table"></i>Upcoming Products </a></li>

<li><a href="upcoming_insert.php"><i class="menu-icon icon-paste"></i>Insert upcoming products </a></li>
