...
$sql=mysqli_query($con,"update upcoming set productName='$productname',productCompany='$productcompany' where id='$pid' ");
...
<?php $query=mysqli_query($con,"select upcoming.productName,upcoming.productCompany from upcoming ");
...
<div class="controls"> -->
<img src="Pic/" width="200" height="100"> <a href="update-image.php?id=<?php ?>">Change Image</a>
</div>
</div>
<?php } ?>
<div class="control-group">
