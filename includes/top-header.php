...
<li  style="margin-left: 377px; color: #000; font-size: -4px;" ></li>
...
<!-- 
<div>
	<img style="height=120px"; width="100px"; src="logo.png">

	<h1 style= "background: #fc7cb6 ; color:#db4214 ; height=70px" ; width="150px">Esell</h1>
