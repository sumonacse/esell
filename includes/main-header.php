...
?>
<div style="background-color: #faedde" class="main-header">
<div class="container">
<div class="row">
...
<img style="margin-top: -30px;margin-left: -15px;height: 50px;width: 130px; padding-bottom: 5px;padding-top: 5px;" data-echo="logo.png" src="assets/images/blank.gif" alt="">
</a> </h2>
</a>
</div>
</div>
