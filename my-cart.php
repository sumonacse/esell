                      ...
                      <td colspan="7">
                        <div class="shopping-cart-btn">
                          <span class="">
                            ...
                            <input type="submit"  name="remove_all" value="Remove All" class="btn btn-upper btn-danger mr-3 pull-right outer-right-xs">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="romove-item">
                        <a href="remove_cart_item.php?pid=<?php echo $row['id']; ?>">X</a>
                      </td>
                      <td class="cart-image">
                      ...
                      <td class="cart-product-name-info">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-8">
                            <?php $rt=mysqli_query($con,"select * from productreviews where productId='$pd'"); $num=mysqli_num_rows($rt);{?>
