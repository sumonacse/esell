...
<form class="register-form" role="form" method="post">
  ...
  <textarea class="form-control unicase-form-control text-input" name="billingaddress" id="shippingaddress" required="required"><?php echo $row['billingAddress']; ?></textarea>
  </div>
  <div class="form-group">
  ...
  <label><input type="checkbox" id="billing_address" name="billing_address">  Shipping address is Same</label> </br>
  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button" onclick="form_submit()">Update</button>
</form>
<?php } ?>
</div>
</div>
...
{
?>
<form class="register-form" role="form" method="post" id="shipping_form">
  <div class="form-group">
  <label class="info-title" for="Shipping Address">Shipping Address<span>*</span></label>
  <textarea class="form-control unicase-form-control text-input" name="shippingaddress" id="billingaddress" required="required"><?php echo $row['shippingAddress'];?></textarea>
  </div>
  <div class="form-group">
...
$('#billing_address').click(function () {
  ...
  $("#billing_address").click(function(){
    ...
    if($('#billing_address')){
      $('textarea#billingaddress').val($('textarea#shippingaddress').val());
      $('#shippingstate').val($('#bilingstate').val());
      $('#shippingcity').val($('#billingcity').val());
      $('#shippingpincode').val($('#billingpincode').val());
    } else {
      $('textarea#shippingaddress').val("");
      $('#shippingstate').val("");
      $('#shippingcity').val("");
      $('#shippingpincode').val("");
    };
